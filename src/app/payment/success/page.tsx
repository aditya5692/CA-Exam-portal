    ...
    return (
        <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-slate-50 p-6">
            ...
            <div className="relative w-full max-w-2xl">
                <div className="group relative overflow-hidden rounded-lg bg-white p-12 text-center shadow-[0_40px_100px_-20px_rgba(0,0,0,0.1)]">
                    ...
                    <div className="relative mb-10 inline-block">
                        <div className="flex h-24 w-24 items-center justify-center rounded-lg bg-emerald-500 text-white shadow-[0_20px_40px_-5px_rgba(16,185,129,0.3)]">
                            <CheckCircle size={48} weight="bold" />
                        </div>
                        <div className="absolute -right-4 -top-4 flex h-10 w-10 items-center justify-center rounded-lg bg-white text-emerald-500 shadow-lg">
                    ...
                    <div className="relative flex flex-col items-center justify-center gap-4 sm:flex-row">
                        <Link
                            href={dashboardHref}
                            className="group flex w-full items-center justify-center gap-3 rounded-lg bg-slate-900 px-10 py-5 text-xs font-black uppercase tracking-[0.2em] text-white shadow-2xl shadow-slate-200 transition-all hover:bg-slate-800 sm:w-auto"
                        >
                            Enter Dashboard
                        ...
                        <Link
                            href={workspaceHref}
                            className="w-full rounded-lg border border-slate-200 bg-white px-10 py-5 text-xs font-black uppercase tracking-[0.2em] text-slate-600 transition-all hover:bg-slate-50 sm:w-auto"
                        >
                            {workspaceLabel}
                        </Link>
                    </div>
