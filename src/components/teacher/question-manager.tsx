                ...
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8 relative z-10">
                    ...
                    <div className="flex flex-wrap gap-3 items-center">
                        ...
                        <Link
                            ...
                            className="h-12 rounded-lg bg-white border border-slate-200 text-slate-600 font-bold text-xs hover:border-indigo-300 hover:bg-indigo-50 hover:text-indigo-600 transition-all active:scale-95 flex items-center gap-2 px-5 shadow-sm"
                        >
                        ...
                        <div ref={dropdownRef} className="relative">
                            ...
                            {showDropdown && (
                                <div className="absolute right-0 mt-3 w-64 rounded-lg bg-white border border-slate-100 shadow-xl p-2 z-[100] animate-in fade-in slide-in-from-top-2 duration-200">
                                    <button
                                        type="button"
                                        onClick={handleDownloadTemplate}
                                        className="w-full flex items-center gap-3 p-3 hover:bg-slate-50 rounded-lg transition-all text-left"
                                    >
                                    ...
                                    <button
                                        ...
                                        className="w-full flex items-center gap-3 p-3 hover:bg-slate-50 rounded-lg transition-all text-left mt-1"
                                    >
                ...
                <div className="space-y-6">
                    <div className="space-y-2.5">
                        ...
                        <textarea
                            ...
                            className="w-full bg-slate-50/50 border border-slate-200 rounded-lg p-4 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:bg-white focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-400 transition-all font-medium resize-none shadow-sm"
                        />
                    </div>
                    ...
                    <div className="space-y-3">
                        <div className="flex items-center justify-between">
                            ...
                            <span className="text-[10px] font-bold text-emerald-600 uppercase tracking-widest bg-emerald-50 px-2 py-0.5 rounded-lg">Select Correct</span>
                        </div>
                        <div className="space-y-2.5">
                                ...
                                <div key={i} className="flex gap-2">
                                    <div className="flex-1">
                                        <input
                                            ...
                                            className="w-full h-11 bg-slate-50/50 border border-slate-200 rounded-lg px-4 text-sm font-medium text-slate-900 focus:bg-white focus:border-indigo-400 focus:ring-4 focus:ring-indigo-500/10 outline-none transition-all shadow-sm"
                                        />
                                    </div>
                                    <button 
                                        onClick={() => toggleCorrect(i)}
                                        className={cn(
                                            "w-11 h-11 shrink-0 rounded-lg border-2 transition-all flex items-center justify-center active:scale-95 shadow-sm",
                    ...
                    <div className="grid grid-cols-2 gap-4 pt-4 border-t border-slate-100">
                        <div className="space-y-2">
                            ...
                            <select 
                                ...
                                className="w-full h-11 bg-white border border-slate-200 rounded-lg px-3 text-sm font-semibold text-slate-700 outline-none focus:border-indigo-400 shadow-sm"
                            >
                                <option>Easy</option>
                        ...
                        <div className="space-y-2">
                            ...
                            <input 
                                ...
                                className="w-full h-11 bg-white border border-slate-200 rounded-lg px-3 text-sm font-semibold text-slate-700 placeholder:text-slate-300 outline-none focus:border-indigo-400 shadow-sm"
                            />
                        </div>
                    </div>
                    ...
                    <button 
                        ...
                        className="w-full h-12 rounded-lg bg-slate-900 text-white font-bold text-sm hover:bg-indigo-600 shadow-lg shadow-slate-900/10 transition-all active:scale-[0.98] flex items-center justify-center gap-2 mt-2 disabled:opacity-50 disabled:pointer-events-none"
                    >
