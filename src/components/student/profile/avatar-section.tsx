...
export function ProfileHeader({ 
    ...
    return (
        <div className="student-surface rounded-lg px-6 py-7 md:px-8 md:py-8  ">
            <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-6">
            <div className="flex flex-col md:flex-row items-center md:items-center gap-6 text-center md:text-left">
                <div className="relative w-28 h-28 rounded-lg overflow-hidden border border-[var(--student-border)] bg-[var(--student-panel-solid)] shadow-[0_18px_40px_rgba(55,48,38,0.08)]">
            ...
            <div className="flex items-center gap-3 w-full md:w-auto mt-4 md:mt-0">
                <button 
                    onClick={onEdit}
                    className="student-button-secondary flex-1 md:flex-none inline-flex items-center justify-center gap-2 rounded-lg px-6 py-3.5 text-xs font-black uppercase tracking-widest transition-all active:scale-95"
                >
                ...
                <button 
                    ...
                    className="student-button-primary flex-1 md:flex-none inline-flex items-center justify-center gap-2 rounded-lg px-6 py-3.5 text-xs font-black uppercase tracking-widest transition-all active:scale-95 disabled:cursor-not-allowed disabled:opacity-50"
                >
