...
export function ResumeCard({ progress }: ResumeCardProps) {
    ...
    return (
        <div className="group relative overflow-hidden rounded-3xl border border-[var(--student-accent-soft-strong)] bg-white p-6 shadow-[0_20px_40px_rgba(31,92,80,0.08)] transition-all hover:shadow-[0_24px_48px_rgba(31,92,80,0.12)]">
            ...
            <div className="relative flex items-center gap-6">
                <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-[var(--student-accent-soft)] text-[var(--student-accent-strong)] shadow-sm">
                ...
                <Link 
                    href={href}
                    className="flex h-12 items-center gap-3 rounded-2xl bg-[var(--student-accent-strong)] px-6 text-[10px] font-black uppercase tracking-[0.2em] text-white shadow-lg transition-all hover:bg-[var(--student-accent-stronger)] active:scale-95"
                >
