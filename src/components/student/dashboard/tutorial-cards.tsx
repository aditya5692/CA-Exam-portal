...
export function TutorialCards() {
    ...
    return (
        <div className="mb-8 animate-in fade-in slide-in-from-top-4 duration-700">
            <div className="relative overflow-hidden rounded-lg border border-[#e6dccd] bg-white p-6 shadow-[0_20px_50px_rgba(55,48,38,0.06)] sm:p-10">
                ...
                <div className="relative z-10">
                    ...
                    <div className="grid lg:grid-cols-[1fr_1.5fr] gap-8 items-center">
                        <div className="space-y-6">
                            ...
                            <div className="flex h-16 w-16 items-center justify-center rounded-lg bg-[#f4ede2] transition-transform duration-500 hover:scale-110" style={{ color: step.color }}>
                            ...
                            <div className="flex items-center gap-3 pt-4">
                                {currentStep > 0 && (
                                    <button 
                                        ...
                                        className="flex h-12 w-12 items-center justify-center rounded-lg border border-[#e6dccd] bg-white text-[#1f5c50] transition-all hover:bg-[#f4ede2]"
                                    >
                                ...
                                <button 
                                    ...
                                    className="flex flex-1 items-center justify-center gap-3 rounded-lg bg-[#1f5c50] py-3.5 px-6 text-[10px] font-black uppercase tracking-[0.2em] text-white shadow-[0_12px_24px_rgba(31,92,80,0.15)] transition-all hover:bg-[#18493f] active:scale-95"
                                >
                        ...
                        <div className="hidden lg:block relative group">
                            <div className="absolute inset-0 bg-gradient-to-tr from-[#1f5c50]/5 to-transparent rounded-lg -m-4 group-hover:m-0 transition-all duration-700" />
                            <div className="aspect-[16/9] bg-[#f4ede2] rounded-lg border border-[#e6dccd] flex items-center justify-center shadow-inner overflow-hidden">
                                {/* Visual representation of the step */}
                                <div className="text-center p-8 animate-in zoom-in-95 duration-700">
                                    <div className="inline-flex h-20 w-20 items-center justify-center rounded-lg bg-white shadow-lg mb-6 text-[#1f5c50]">
