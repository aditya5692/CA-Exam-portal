    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[400px] text-center p-8 animate-in fade-in zoom-in-95 duration-1000">
            <div className="relative mb-10">
                ...
                <div className="relative w-24 h-24 bg-emerald-500 rounded-[32px] flex items-center justify-center shadow-2xl shadow-emerald-100 transform rotate-12 transition-transform duration-700">
                    <CheckCircle size={48} weight="bold" className="text-white" />
                </div>
                <div className="absolute -top-4 -right-4 bg-slate-900 rounded-2xl p-2.5 shadow-xl animate-bounce">
